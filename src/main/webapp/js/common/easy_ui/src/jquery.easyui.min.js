    ...
    */
    doCellTip: function (jq, params) {
        function showTip(data, td, e) {
        	var columns = data.options.columns[0];
        	if(columns[td.cellIndex]!=null&&columns[td.cellIndex].toolTip==false){
        		return;
        	}
            ...
            // wangchao
            var text = $(td).text();
            var a = jQuery(td).find(".placardTitle");
            var placardTitle = a.attr("placardTitle");
            if (placardTitle) {
            	text = placardTitle;
            }
